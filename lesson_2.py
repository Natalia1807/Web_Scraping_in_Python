...
while max_page != hh_pages_max:
    ...
    for vacancy in vacancy_list:
        ...
        vacancy_employer_hh = vacancy.find('a', {'data-qa': 'vacancy-serp__vacancy-employer'}).getText()
        vacancy_salary_hh = vacancy.find('div', {'class': 'vacancy-serp-item__sidebar'}).getText()

        if vacancy_salary_hh != None:
            vacancy_salary_hh = vacancy_salary_hh.split(' ')
            vacancy_salary_hh_curr = vacancy_salary_hh[-1]

            if vacancy_salary_hh[0] == 'от':
                min_salary_hh = ''.join(vacancy_salary_hh[1:-1])
                max_salary_hh = None
            elif vacancy_salary_hh[0] == 'до':
                max_salary_hh = ''.join(vacancy_salary_hh[1:-1])
                min_salary_hh = None
            else:
                min_salary_hh = vacancy_salary_hh[0].split('-')[0]
                max_salary_hh = vacancy_salary_hh[0].split('-')[-1]
        else:
            min_salary_hh = None
            max_salary_hh = None
        ...
        vacancy_hh_data['employer'] = vacancy_employer_hh
        vacancy_hh_data['salary'] = vacancy_salary_hh
        vacancy_hh_data['max_salary'] = max_salary_hh
        vacancy_hh_data['max_salary'] = max_salary_hh
        vacancy_all.append(vacancy_hh_data)
...
while max_page != sj_pages_max:
    ...
    for vacancy in vacancy_list_sj:
        ...
        vacancy_employer_sj = vacancy.find('span', {'class': 'f-test-text-vacancy-item-company-name'}).getText()
        vacancy_salary_sj = vacancy.find('span', {'class': 'f-test-text-company-item-salary'}).getText()

        if vacancy_salary_sj != None:
            vacancy_salary_sj_1 = vacancy_salary_sj.split(' ')
            vacancy_salary_sj_curr = vacancy_salary_sj_1[-1]

            if vacancy_salary_sj_1[0] == 'от':
                min_salary_sj = ''.join(vacancy_salary_sj_1[1:-1])
                max_salary_sj = None
            elif vacancy_salary_sj_1[0] == 'до':
                max_salary_sj = ''.join(vacancy_salary_sj_1[1:-1])
                min_salary_sj = None
            elif vacancy_salary_sj_1[0] == 'По':
                min_salary_sj = None
                max_salary_sj = None
                vacancy_salary_sj_curr = None
            else:
                min_salary_sj = vacancy_salary_sj_1[0].split('-')[0]
                max_salary_sj = vacancy_salary_sj_1[0].split('-')[-1]
        else:
            min_salary_sj = None
            max_salary_sj = None
            vacancy_salary_sj_curr = None
        ...
        vacancy_sj_data['source'] = main_link_sj
        vacancy_sj_data['city'] = vacancy_city_sj
        vacancy_sj_data['employer'] = vacancy_employer_sj
        vacancy_sj_data['salary'] = vacancy_salary_sj
        vacancy_sj_data['max_salary'] = max_salary_sj
        vacancy_sj_data['max_salary'] = max_salary_sj
        vacancy_all.append(vacancy_sj_data)

    # print(vacancy_sj_data)
a = pd.DataFrame(vacancy_all)
print(a)
